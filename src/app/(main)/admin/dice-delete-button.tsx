...
import { deleteDiceRoll } from "./actions";

export function DeleteDiceButton({ rollId }: { rollId: string }) {
  ...
  return (
    <form action={deleteDiceRoll.bind(null, rollId)} className="flex items-center gap-1">
